...
function Home() {
  ...
  const handleActivateAssistant = () => {
    ...
    const welcome =
      "Welcome to Speak2Dine! I'm your digital assistant. How can I help you today?";
  ...
  const handleUserMessage = async (message) => {
    ...
    if (step === -1) {
      if (
        ...
        const r =
          "I am a booking specialist for Speak2Dine. Would you like to reserve a table?";
        setAgentMessage(r);
        speak(r);
      }
    }
    ...
    // STEP 7: Final Confirmation and Database Sync
      ...
      if (input.includes("yes") || input.includes("confirm")) {
        ...
        try {
          ...
          speak(
            "Great news! Your reservation at Speak2Dine is confirmed. We look forward to seeing you!",
          );
          setIsSuccess(true);
          setAssistantActivated(false);
        } catch (e) {
  ...
  return (
    <div className="hero-wrapper">
      ...
      <footer className="home-footer">
        <p>
          © 2026 Speak2Dine | Fast & Simple Table Reservations | BUILT BY PRERAK
          BHATT
        </p>
      </footer>
    </div>
